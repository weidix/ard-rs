...
impl Icon {
    fn bytes(self) -> &'static [u8] {
        match self {
            ...
            Self::Camera => include_bytes!("../assets/icons/camera.svg"),
            Self::AppSwitcher => include_bytes!("../assets/icons/app-switcher.svg"),
            Self::Layers => include_bytes!("../assets/icons/layers.svg"),
            Self::Desktop => include_bytes!("../assets/icons/desktop.svg"),
